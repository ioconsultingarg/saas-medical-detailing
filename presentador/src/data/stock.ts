...
export const stockInicial: ItemStock[] = [
  { sku: 'DM-20-30', productoId: 'cardio', nombre: 'Lipvera 20 mg × 30 comp.', tipo: 'comercial', unidades: 1240, umbralBajo: 300 },
  { sku: 'DM-20-60', productoId: 'cardio', nombre: 'Lipvera 20 mg × 60 comp.', tipo: 'comercial', unidades: 180, umbralBajo: 250 },
  { sku: 'DM-10-30', productoId: 'cardio', nombre: 'Lipvera 10 mg × 30 comp.', tipo: 'comercial', unidades: 0, umbralBajo: 200 },
  ...
  { sku: 'RM-200-200', productoId: 'respira', nombre: 'Respirel 200 mcg × 200 dosis', tipo: 'comercial', unidades: 820, umbralBajo: 250 },
  { sku: 'RM-100-120', productoId: 'respira', nombre: 'Respirel 100 mcg × 120 dosis', tipo: 'comercial', unidades: 95, umbralBajo: 200 },
