...
export const stockInicial: ItemStock[] = [
  ...
  { sku: 'DM-MM-7', productoId: 'cardio', nombre: 'Muestra médica 20 mg × 7 comp.', tipo: 'muestra', unidades: 460, umbralBajo: 80 },
  ...
  { sku: 'RM-MM-60', productoId: 'respira', nombre: 'Muestra médica × 60 dosis', tipo: 'muestra', unidades: 0, umbralBajo: 60 },
  { sku: 'RM-AERO', productoId: 'respira', nombre: 'Aerocámara espaciadora', tipo: 'material', unidades: 140, umbralBajo: 40 },
